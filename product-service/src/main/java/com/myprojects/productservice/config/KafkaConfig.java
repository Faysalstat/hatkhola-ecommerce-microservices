package com.myprojects.productservice.config;

import com.myprojects.productservice.model.Greeting;
...
public class KafkaConfig {
    ...
    public ConcurrentKafkaListenerContainerFactory<String, String> fooKafkaListenerContainerFactory() {
        return kafkaListenerContainerFactory("swift-group");
    }
    ...
    public ConsumerFactory<String, String> greetingConsumerFactory() {
        Map<String, Object> props = new HashMap<>();
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, "192.168.1.140:9092");
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "swift-group");
        props.put(ConsumerConfig.CLIENT_ID_CONFIG, "client1");
        DefaultKafkaConsumerFactory defaultKafkaConsumerFactory = new DefaultKafkaConsumerFactory<>(props, new StringDeserializer(), new JsonDeserializer<>(String.class));
